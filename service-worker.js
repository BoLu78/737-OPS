...
async function matchOfflineShell(cache) {
  return (
    ...
    await cache.match("./")
  ) || await cache.match("./?v=3.1");
}

async function matchCachedAppScript(cache) {
  return (await cache.match("./app.js?v=3.1")) || await cache.match("./app.js");
}

async function matchCachedManifest(cache) {
  return (await cache.match("./manifest.json?v=3.1")) || await cache.match("./manifest.json");
}
