...
async function matchCachedAppScript(cache) {
  return (await cache.match("./app.js?v=2.5")) || await cache.match("./app.js");
}

async function matchCachedManifest(cache) {
  return (await cache.match("./manifest.json?v=2.5")) || await cache.match("./manifest.json");
}
